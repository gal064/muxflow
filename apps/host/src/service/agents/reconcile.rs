    ...
    for ((pane_id, adapter_id), (_pane, adapter)) in detected {
        ...
        state.agents.insert(
            ...
            StoredAgent {
                ...
                codex_terminal_root_turn_ids: Default::default(),
                codex_subagent_root_turn_ids: Default::default(),
                codex_subagents_awaiting_root: Default::default(),
                codex_latest_subagent_turns: Default::default(),
                codex_terminal_subagent_turns: Default::default(),
